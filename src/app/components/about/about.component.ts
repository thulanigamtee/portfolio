...
export class AboutComponent {
  info: Info = {
    ...
    title: 'About me',
    description:
      'I am an experienced Full Stack Software Developer with three years of expertise in the field. Throughout my career, I have had the opportunity to work on a variety of projects, which has allowed me to develop a wide range of skills. I am passionate about creating high-quality software and am always looking for ways to improve my skills.',
  };
}
